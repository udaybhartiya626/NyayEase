      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <Link to="/" className="flex items-center">
              <span className="text-2xl font-semibold whitespace-nowrap">NyayEase</span>
            </Link>
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3">
            ...
            <div>
              <h2 className="mb-4 text-sm font-semibold uppercase text-white">User Portal</h2>
              <ul className="text-gray-400">
                <li className="mb-2">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-400 sm:text-center">
            © {currentYear} <Link to="/" className="hover:underline">NyayEase™</Link>. All Rights Reserved.
          </span>
